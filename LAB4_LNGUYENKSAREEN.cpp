/*****************************************************************************
*                                                                            *
*       Source title:   LAB4_LNGUYENKSAREEN.CPP
...
// file.
//
CLAB4_LNGUYENKSAREEN theApp(ProductDatasheetFlow);
...
BOOL CLAB4_LNGUYENKSAREEN::UserInit( void )
{
    //////////////////////////////////////////////////////////////////////////
	...
	dpinvecload( "LAB4_LNGUYENKSAREEN.evd" ); // load vector sheet so digital pins can use machine resources
...
BOOL CLAB4_LNGUYENKSAREEN::UserExit( void )
{
    return TRUE;
}
...
BOOL CLAB4_LNGUYENKSAREEN::OnTestInit( void )
{
    //////////////////////////////////////////////////////////////////////////
...
BOOL CLAB4_LNGUYENKSAREEN::OnTestExit( void )
{
    return TRUE;
}
...
BOOL CLAB4_LNGUYENKSAREEN::OnTestStartup( void )
{
...
BOOL CLAB4_LNGUYENKSAREEN::OnTestCompletion( void )
{	
...
BOOL CLAB4_LNGUYENKSAREEN::OnLogData( void )
{
    int PassFail;
...
BOOL CLAB4_LNGUYENKSAREEN::OnFailSite( int site )
{
	if (site == MS_SITE0) {
		apuset( nOE, APU_VIOFF, 0.0, APU_30V, APU_1MA, PIN_TO_VI );
		apuset( DIR, APU_VIOFF, 0.0, APU_30V, APU_1MA, PIN_TO_VI );
...
int CLAB4_LNGUYENKSAREEN::OnSot(int SotValue)
{
    return SotValue;
}
...
BOOL CLAB4_LNGUYENKSAREEN::OnUtilError(int errnum)
{
    return TRUE;
}
...
BOOL CLAB4_LNGUYENKSAREEN::OnInterlock(ULONG intlocks)
{
    return TRUE;
}
